            ...
            <div class="col-lg-10 col-lg-offset-0">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            ...
                            echo "</div>";
                            echo form_checkbox('service[]', 'Các sản phẩm, giải pháp ứng dụng công nghệ 4.0', (in_array('Các sản phẩm, giải pháp ứng dụng công nghệ 4.0', $service, '')? true : false), 'class="btn-checkbox"');
                            echo '<span style="color:blue">Các sản phẩm, giải pháp ứng dụng công nghệ 4.0</span><br>';
                            echo form_checkbox('service[]', 'Các sản phẩm, giải pháp phần mềm mới', (in_array('Các sản phẩm, giải pháp phần mềm mới', $service, '')? true : false), 'class="btn-checkbox"');
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <p style="color:red;">Ghi chú: Nếu đã có GCN bản quyền thì đặt link vào ô trên, nếu chưa có thì tải mẫu Cam kết bản quyền tại đây và đặt link vào ô trên.</p>
                            <br>
                            <br>
                            <?php
                            echo form_error('certificate');
                            echo form_input('certificate', set_value('certificate', $product['certificate']), 'class="form-control"');
                            ?>
                        </div>
                    </div>
                </div>
